...
export const listContent: Record<string, { paragraphs: string[]; faqs: { q: string; a: string }[] }> = {
  'least-sugar': {
    paragraphs: [
      'Sugar is where canned lattes differ most. The sweetest flavored dairy cans we have checked against a label carry 38 to 39 g in an 11 oz can, nearly three quarters of it added, while the cans at the top of this list reach zero by sweetening with sucralose, and the best of the rest get down to a single gram by leaning on the milk itself or on whole-food sweeteners like dates. La Colombe\'s 2026 reformulation is a sign of where the category is heading: its Vanilla Draft Latte dropped to 15 g, less than half of what the sweetest dairy cans carry.',
    ...
    faqs: [
      { q: 'Which canned latte has the least sugar?', a: 'Loco Coffee\'s two zero-sugar lattes are the only cans we list at 0 g, reaching it with sucralose rather than sugar. Among cans that carry any sugar at all, Slate\'s five lead at 1 g with none of it added.' },
      ...
      { q: 'How much sugar is in a typical canned latte?', a: 'Flavored dairy canned coffees commonly run 15–39 g per can. Honey-sweetened cans are the exception: Bee Keeper\'s five lattes land at 10–11 g in a smaller 8 oz can. The low-sugar end of the category runs 0–8 g.' },
    ],
  },
  'most-caffeine': {
    paragraphs: [
  ...
  'no-added-sugar': {
    paragraphs: [
      'These are the cans with a 0 in the added-sugars line: sweetness, where there is any, comes from the milk itself, from whole ingredients like dates, or from non-nutritive sweeteners that carry no sugar at all. Twelve cans qualify, and they get there four different ways. NOBL keeps it to literally two ingredients (cold brew and oat milk), so the 5 g on its label is oat-milk sugar with nothing added. Slate\'s five lattes lean on stevia and monk fruit, which leaves 1 g of naturally occurring milk sugar next to 20 g of protein. Pop & Bottle sweetens three of its oat milk lattes with dates rather than sugar; the two whose totals it publishes show 8 and 10 g, none of it added. Groundwork does the same with date paste, at 5 g. Loco takes the fourth route and reaches 0 g total with sucralose.',
      'Read the added-sugars line rather than the front of the can. "No refined sugar" is a different claim from "no added sugar", and Pop & Bottle\'s own lineup shows the gap: the Caramel Cold Brew on this list earns the badge with 0 g added, while their Matcha Green Tea wears the same badge over 12 g of added sugar from coconut nectar — unrefined, but added, and the entire sugar content of that can.',
      'If a can you love isn\'t here, the least-sugar list is the neighboring compromise: ten cans publish 5 g of added sugar or less without reaching zero — Bee Keeper\'s five honey-sweetened lattes and La Colombe\'s Everyday Draft Latte at 4 g, and Bones Coffee\'s four flavored lattes at 5 g. All of them taste barely sweetened.',
    ],
    faqs: [
  ...
  'dairy-free': {
    paragraphs: [
      'Every can here is made without dairy — oat milk dominates, with one coconut can, one almond, and one whose brand will only say "plant-based". Beyond the milk itself, the differences that matter are caffeine (50 to 207 mg across this list), sweetener (dates, cane sugar, or none), and storage (most are shelf-stable; NOBL is refrigerated and ships cold).',
